            ...
            {users.length > 0 ? (
              users.map((user, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-6 text-right">{user.TNXid}</td>
                  <td className="py-3 px-6 text-right">{user.batch}</td>
                  ...
                  >
                    <span
                      className={`py-3 my-2 px-6 text-right font-semibold rounded-full ${
                        user.status === "success"
                          ? "bg-green-100"
                          : user.status === "cancel"
                          ? "bg-red-100"
